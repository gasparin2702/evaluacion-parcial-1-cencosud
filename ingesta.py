...
def preparar_sistema_hibrido():
    # verificacion de seguridad para el alumno
    ...
    # 3. procesamiento (chunking)
    splitter = RecursiveCharacterTextSplitter(chunk_size=400, chunk_overlap=50)
    chunks = splitter.split_documents(todos_los_docs)
    
    # 4. vectorizacion usando github models
    ...
    print(f"sistema nutrido con {len(docs_internos)} archivos internos y la fuente de la dt")
